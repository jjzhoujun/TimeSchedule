package com.dreamfly.timeschedule.view;
...
import com.dreamfly.timeschedule.model.MainBaseAdapter;
import com.dreamfly.timeschedule.utils.CommonUtils;
import com.dreamfly.timeschedule.view.MyListView.OnRefreshListener;
...
public class UIMainInterface extends Activity{
...
//                        mListView.onRefreshComplete();
    ...
    private void addTimeTask() {
        if(("").equals(mEditText.getText().toString())){
            ...
            intent.setClass(UIMainInterface.this, UIAddTask.class);
            startActivity(intent);
        } else {
            TimeStruct timeStruct = CommonUtils.getInstance(mContext)
